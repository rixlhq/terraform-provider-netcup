...
func ScpUserFailoveripsV4DataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		MarkdownDescription: "Get all failover IPv4s of this user.",
		Attributes: map[string]schema.Attribute{
			"ip": schema.StringAttribute{
				Optional: true,
				Computed: true,
			},
			"scp_user_failoverips_v4": schema.SetNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					...
					CustomType: ScpUserFailoveripsV4Type{
						ObjectType: types.ObjectType{
							AttrTypes: ScpUserFailoveripsV4Value{}.AttributeTypes(ctx),
						},
					},
				},
				Computed: true,
			...
			"server_id": schema.Int64Attribute{
				Optional:            true,
				Computed:            true,
				Description:         "Filter failover IPv4s of this user by server id",
				MarkdownDescription: "Filter failover IPv4s of this user by server id",
			},
...
type ScpUserFailoveripsV4Model struct {
	Ip                   types.String `tfsdk:"ip"`
	ScpUserFailoveripsV4 types.Set    `tfsdk:"scp_user_failoverips_v4"`
	ServerId             types.Int64  `tfsdk:"server_id"`
	UserId               types.Int64  `tfsdk:"user_id"`
}

var _ basetypes.ObjectTypable = ScpUserFailoveripsV4Type{}

type ScpUserFailoveripsV4Type struct {
	basetypes.ObjectType
}

func (t ScpUserFailoveripsV4Type) Equal(o attr.Type) bool {
	other, ok := o.(ScpUserFailoveripsV4Type)
...
func (t ScpUserFailoveripsV4Type) String() string {
	return "ScpUserFailoveripsV4Type"
}

func (t ScpUserFailoveripsV4Type) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	var diags diag.Diagnostics

	attributes := in.Attributes()

	cidrSuffixAttribute, ok := attributes["cidr_suffix"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`cidr_suffix is missing from object`)

		return nil, diags
	}

	cidrSuffixVal, ok := cidrSuffixAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`cidr_suffix expected to be basetypes.Int64Value, was: %T`, cidrSuffixAttribute))
	}
	...
	return ScpUserFailoveripsV4Value{
		CidrSuffix: cidrSuffixVal,
...
func NewScpUserFailoveripsV4ValueNull() ScpUserFailoveripsV4Value {
	return ScpUserFailoveripsV4Value{
		state: attr.ValueStateNull,
	}
}

func NewScpUserFailoveripsV4ValueUnknown() ScpUserFailoveripsV4Value {
	return ScpUserFailoveripsV4Value{
		state: attr.ValueStateUnknown,
	}
}

func NewScpUserFailoveripsV4Value(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (ScpUserFailoveripsV4Value, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	for name, attributeType := range attributeTypes {
		...
		if !ok {
			diags.AddError(
				"Missing ScpUserFailoveripsV4Value Attribute Value",
				"While creating a ScpUserFailoveripsV4Value value, a missing attribute value was detected. "+
					"A ScpUserFailoveripsV4Value must contain values for all attributes, even if null or unknown. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("ScpUserFailoveripsV4Value Attribute Name (%s) Expected Type: %s", name, attributeType.String()),
			)
		...
		if !attributeType.Equal(attribute.Type(ctx)) {
			diags.AddError(
				"Invalid ScpUserFailoveripsV4Value Attribute Type",
				"While creating a ScpUserFailoveripsV4Value value, an invalid attribute value was detected. "+
					"A ScpUserFailoveripsV4Value must use a matching attribute type for the value. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("ScpUserFailoveripsV4Value Attribute Name (%s) Expected Type: %s\n", name, attributeType.String())+
					fmt.Sprintf("ScpUserFailoveripsV4Value Attribute Name (%s) Given Type: %s", name, attribute.Type(ctx)),
			)
		}
	}
	...
	for name := range attributes {
		...
		if !ok {
			diags.AddError(
				"Extra ScpUserFailoveripsV4Value Attribute Value",
				"While creating a ScpUserFailoveripsV4Value value, an extra attribute value was detected. "+
					"A ScpUserFailoveripsV4Value must not contain values beyond the expected attribute types. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("Extra ScpUserFailoveripsV4Value Attribute Name: %s", name),
			)
		}
	}

	if diags.HasError() {
		return NewScpUserFailoveripsV4ValueUnknown(), diags
	}
...
func NewScpUserFailoveripsV4ValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) ScpUserFailoveripsV4Value {
	object, diags := NewScpUserFailoveripsV4Value(attributeTypes, attributes)
	...
	if diags.HasError() {
		...
		panic("NewScpUserFailoveripsV4ValueMust received error(s): " + strings.Join(diagsStrings, "\n"))
	}

	return object
}

func (t ScpUserFailoveripsV4Type) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewScpUserFailoveripsV4ValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewScpUserFailoveripsV4ValueUnknown(), nil
	}
	...
	return NewScpUserFailoveripsV4ValueMust(ScpUserFailoveripsV4Value{}.AttributeTypes(ctx), attributes), nil
}

func (t ScpUserFailoveripsV4Type) ValueType(ctx context.Context) attr.Value {
	return ScpUserFailoveripsV4Value{}
}

var _ basetypes.ObjectValuable = ScpUserFailoveripsV4Value{}

type ScpUserFailoveripsV4Value struct {
	CidrSuffix basetypes.Int64Value  `tfsdk:"cidr_suffix"`
...
func (v ScpUserFailoveripsV4Value) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	attrTypes := make(map[string]tftypes.Type, 7)

	var val tftypes.Value
	var err error

	attrTypes["cidr_suffix"] = basetypes.Int64Type{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.CidrSuffix.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["cidr_suffix"] = val
...
func (v ScpUserFailoveripsV4Value) IsNull() bool {
	return v.state == attr.ValueStateNull
}

func (v ScpUserFailoveripsV4Value) IsUnknown() bool {
	return v.state == attr.ValueStateUnknown
}

func (v ScpUserFailoveripsV4Value) String() string {
	return "ScpUserFailoveripsV4Value"
}

func (v ScpUserFailoveripsV4Value) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	attributeTypes := map[string]attr.Type{
		"cidr_suffix": basetypes.Int64Type{},
...
func (v ScpUserFailoveripsV4Value) Equal(o attr.Value) bool {
	other, ok := o.(ScpUserFailoveripsV4Value)
	...
	if !v.CidrSuffix.Equal(other.CidrSuffix) {
		return false
	}
...
func (v ScpUserFailoveripsV4Value) Type(ctx context.Context) attr.Type {
	return ScpUserFailoveripsV4Type{
		basetypes.ObjectType{
...
func (v ScpUserFailoveripsV4Value) AttributeTypes(ctx context.Context) map[string]attr.Type {
