...
func ScpServerInterfacesDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"scp_server_interfaces": schema.SetNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					...
					CustomType: ScpServerInterfacesType{
						ObjectType: types.ObjectType{
							AttrTypes: ScpServerInterfacesValue{}.AttributeTypes(ctx),
						},
					},
				},
				Computed: true,
...
type ScpServerInterfacesModel struct {
	LoadRdns            types.Bool  `tfsdk:"load_rdns"`
	ScpServerInterfaces types.Set   `tfsdk:"scp_server_interfaces"`
	ServerId            types.Int64 `tfsdk:"server_id"`
}

var _ basetypes.ObjectTypable = ScpServerInterfacesType{}

type ScpServerInterfacesType struct {
	basetypes.ObjectType
}

func (t ScpServerInterfacesType) Equal(o attr.Type) bool {
	other, ok := o.(ScpServerInterfacesType)
...
func (t ScpServerInterfacesType) String() string {
	return "ScpServerInterfacesType"
}

func (t ScpServerInterfacesType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	return ScpServerInterfacesValue{
		Driver:        driverVal,
...
func NewScpServerInterfacesValueNull() ScpServerInterfacesValue {
	return ScpServerInterfacesValue{
		state: attr.ValueStateNull,
	}
}

func NewScpServerInterfacesValueUnknown() ScpServerInterfacesValue {
	return ScpServerInterfacesValue{
		state: attr.ValueStateUnknown,
	}
}

func NewScpServerInterfacesValue(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (ScpServerInterfacesValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	for name, attributeType := range attributeTypes {
		...
		if !ok {
			diags.AddError(
				"Missing ScpServerInterfacesValue Attribute Value",
				"While creating a ScpServerInterfacesValue value, a missing attribute value was detected. "+
					"A ScpServerInterfacesValue must contain values for all attributes, even if null or unknown. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("ScpServerInterfacesValue Attribute Name (%s) Expected Type: %s", name, attributeType.String()),
			)
		...
		if !attributeType.Equal(attribute.Type(ctx)) {
			diags.AddError(
				"Invalid ScpServerInterfacesValue Attribute Type",
				"While creating a ScpServerInterfacesValue value, an invalid attribute value was detected. "+
					"A ScpServerInterfacesValue must use a matching attribute type for the value. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("ScpServerInterfacesValue Attribute Name (%s) Expected Type: %s\n", name, attributeType.String())+
					fmt.Sprintf("ScpServerInterfacesValue Attribute Name (%s) Given Type: %s", name, attribute.Type(ctx)),
			)
		}
	}
	...
	for name := range attributes {
		...
		if !ok {
			diags.AddError(
				"Extra ScpServerInterfacesValue Attribute Value",
				"While creating a ScpServerInterfacesValue value, an extra attribute value was detected. "+
					"A ScpServerInterfacesValue must not contain values beyond the expected attribute types. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("Extra ScpServerInterfacesValue Attribute Name: %s", name),
			)
		}
	}

	if diags.HasError() {
		return NewScpServerInterfacesValueUnknown(), diags
	}
...
func NewScpServerInterfacesValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) ScpServerInterfacesValue {
	object, diags := NewScpServerInterfacesValue(attributeTypes, attributes)
	...
	if diags.HasError() {
		...
		panic("NewScpServerInterfacesValueMust received error(s): " + strings.Join(diagsStrings, "\n"))
	}

	return object
}

func (t ScpServerInterfacesType) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewScpServerInterfacesValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewScpServerInterfacesValueUnknown(), nil
	}
	...
	return NewScpServerInterfacesValueMust(ScpServerInterfacesValue{}.AttributeTypes(ctx), attributes), nil
}

func (t ScpServerInterfacesType) ValueType(ctx context.Context) attr.Value {
	return ScpServerInterfacesValue{}
}

var _ basetypes.ObjectValuable = ScpServerInterfacesValue{}

type ScpServerInterfacesValue struct {
...
func (v ScpServerInterfacesValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
...
func (v ScpServerInterfacesValue) IsNull() bool {
	return v.state == attr.ValueStateNull
}

func (v ScpServerInterfacesValue) IsUnknown() bool {
	return v.state == attr.ValueStateUnknown
}

func (v ScpServerInterfacesValue) String() string {
	return "ScpServerInterfacesValue"
}

func (v ScpServerInterfacesValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (v ScpServerInterfacesValue) Equal(o attr.Value) bool {
	other, ok := o.(ScpServerInterfacesValue)
...
func (v ScpServerInterfacesValue) Type(ctx context.Context) attr.Type {
	return ScpServerInterfacesType{
		basetypes.ObjectType{
...
func (v ScpServerInterfacesValue) AttributeTypes(ctx context.Context) map[string]attr.Type {
