...
var _ datasource.DataSource = &ScpTasksDataSource{}

// NewScpTasksDataSource returns a new data source.
func NewScpTasksDataSource() datasource.DataSource {
	return &ScpTasksDataSource{}
}

// ScpTasksDataSource maps the /api/v1/tasks SCP endpoint to a Terraform data source.
type ScpTasksDataSource struct {
	client *scpclient.Client
}

func (d *ScpTasksDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_scp_tasks"
}

func (d *ScpTasksDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ScpTasksDataSourceSchema(ctx)
}

func (d *ScpTasksDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
